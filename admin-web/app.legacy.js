...
async function loadPage(page) {
  ...
  // ทุกหน้า migrate เข้า src/pages แล้ว (2026-07-18) — ถ้าหลุดมาถึงตรงนี้แปลว่า
  // module registry โหลดไม่สำเร็จ แสดง error แทน legacy renderer ที่ถูกถอดออก
  container.innerHTML = `<div class="text-center py-20 text-red-500"><span class="material-icons-round text-4xl">error</span><p class="mt-2">โหลดหน้า "${escapeHtml(page)}" ไม่สำเร็จ — โมดูลหน้าไม่ถูกลงทะเบียน (ลอง refresh หรือเช็ค console)</p></div>`;
}
...
// Dashboard
// ============================================
// [removed 2026-07-18] legacy renderer migrated to src/pages
