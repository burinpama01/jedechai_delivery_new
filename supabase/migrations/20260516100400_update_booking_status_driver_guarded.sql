-- Server-side guard for driver-initiated booking status transitions.
-- Replaces client-side auth check in updateBookingStatusGuarded() with DB-level enforcement.
