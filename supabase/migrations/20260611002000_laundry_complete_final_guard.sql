-- Final laundry completion guard.
-- Must replay after all Laundry migrations so the effective RPC keeps:
-- - driver actor authorization
-- - pickup evidence requirement
-- - in_transit completion state
-- - cash branch with zero wallet credit
-- - wallet ledger duplicate guard against text related_booking_id
