...
class BookingService {
  ...
  /// Offer delivery is owned by the server-side driver offer worker.
  ...
  Future<void> _notifyDriversAboutNewRide(Booking booking) async {
    // The booking trigger creates an offer. Never fall back to broadcasting
    // on an RPC or network error; the worker retries the targeted push.
    debugLog('Driver offer queued by server for booking ${booking.id}');
  }
