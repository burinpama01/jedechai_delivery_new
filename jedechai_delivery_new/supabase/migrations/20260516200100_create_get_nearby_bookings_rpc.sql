-- ISSUE-037: Create get_nearby_bookings RPC function
-- Called by driver app to find bookings within GPS radius
...
AS $$
  ...
  WHERE
    driver_id IS NULL
    AND status IN ('pending', 'ready_for_pickup', 'matched')
